...
int TM1620_Init(void)
{
	...
	buffer[0]=0x00;
	buffer[1]=0x00;
	if(HAL_I2C_Mem_Write(&hi2c1, 0x22, 0x03,I2C_MEMADD_SIZE_8BIT, buffer, 2, 20)==HAL_OK)
	{
	...
	buffer[0]=0x08;
	buffer[1]=0x00;
	if(HAL_I2C_Mem_Write(&hi2c1, 0x22, 0x04,I2C_MEMADD_SIZE_8BIT, buffer, 2, 20)==HAL_OK)
	{
	...
	buffer[0]=0x00;
	buffer[1]=0x00;
	if(HAL_I2C_Mem_Write(&hi2c1, 0x22, 0x06,I2C_MEMADD_SIZE_8BIT, buffer, 2, 20)==HAL_OK)
	{
